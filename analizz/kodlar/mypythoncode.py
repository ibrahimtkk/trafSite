...
def havaDurumu(request, cursor):
    vSegDir = 0
    yil = 2017
    havaOlayi = request.POST.get('HavaDurumuHavaOlayi')
    secilenSemt = request.POST.get('HavaDurumuSemt')
    ...
    if (havaOlayi=='Yağmur'):
        ...
        havaOlayliDegerler = hava.havaOlayindanAyVeGunBulYagmur(havaOlayi, secilenSemt)
